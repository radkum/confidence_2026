...
.GUID 0dc77dc4-40a6-410e-a61b-f5301d17d6a6

.AUTHOR Alain Herve

.COMPANYNAME alainQtec

.COPYRIGHT Alain Herve
...
.EXAMPLE
    . ([scriptblock]::Create((Invoke-RestMethod -Verbose:$false -Method Get https://api.github.com/gists/afe67e3c7b2d6fce2770e6c57314b113).files.'Install-OpenSSL.ps1'.content)); Install-OpenSSL        # A one-liner to install OpenSSL using the latest installer fuction from the gist :)
.LINK
