...
pub enum ItemInfo {
    ...
    RegistrySetValue {
        ...
        tid: u32,
        key_name: StringBuff,
        value_name: StringBuff,
        data_type: u32,
        //data: Vec<u8>,
    },
    // Enumeration of suspicious registry keys (AMSI providers reconnaissance).
    RegistryEnumerate {
        pid: u32,
        tid: u32,
        key_name: StringBuff,
...
// IOCTL codes shared between KM and UM
// Type = 0x8000 (custom), Function starts at 0x800
pub const IOCTL_TYPE: u32 = 0x8000;
pub const IOCTL_FUNCTION_REQUEST: u32 = 0x800;
pub const IOCTL_FUNCTION_KILL_PROCESS: u32 = 0x801;
